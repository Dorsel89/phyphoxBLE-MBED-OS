...
{	
	...
	*/
	...
	ble::AdvertisingParameters adv_parameters(ble::advertising_type_t::CONNECTABLE_UNDIRECTED, ble::adv_interval_t(ble::millisecond_t(1200)));
...
{
	while(1)
		server -> ble.processEvents();// waitForEvent(); //deprecated.
}
